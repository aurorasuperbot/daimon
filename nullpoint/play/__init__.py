"""nullpoint.play — match rendering, file-watcher inbox, battle UI.
...
V1 alpha scope:
  ...
  - `cli` — `nullpoint play-render` commands
...
from nullpoint.play.schema import Match, Action, Round, Outcome  # noqa: F401
